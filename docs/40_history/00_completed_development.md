...
| [`07_maneuver_transient.md`](07_maneuver_transient.md) | Transient maneuver loads (Phase G0) | Increment 1 — ZAERO MLOADS card set, Level-1 quasi-steady, open-loop, restrained l-set Newmark-β. Future Steps 59–63 (modal basis, MASSSET, free-flight) land here |
