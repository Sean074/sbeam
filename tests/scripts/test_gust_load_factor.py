"""S-GUST gates — scripts/gust_load_factor.py (FAR/CS 23.341 quasi-static gust).
...
from scripts.gust_load_factor import (
    UNIT_SYSTEMS,
    alleviation_factor,
...
class TestSGust6GeneratedDeck:
    ...
    def test_header_records_how_it_was_made(self, generated):
        ...
        assert "GENERATED by scripts/gust_load_factor.py" in text
